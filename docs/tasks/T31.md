# T31 — The full-season scenario
*Stage 9 · generated from `docs/spec/`. Do not edit — edit the specification and re-run `scripts/build-task-bundles.py`.*
